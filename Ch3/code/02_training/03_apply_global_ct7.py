...
# CHANGED: Point to Cluster7 Model Directory
MODEL_DIR = os.path.join(PROJECT_DIR, "02_Training", "02_Model_Cluster7_Results")
# CHANGED: Unique Output Directory for Cluster7
OUTPUT_DIR = os.path.join(PROJECT_DIR, "02_Training", "03_Global_Results_Cluster7")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Input Files
# CHANGED: Correct Model Filename
MODEL_PATH = os.path.join(MODEL_DIR, "final_model_cluster7.pkl")
...
GLOBAL_INDEX_CSV = os.path.join(OUTPUT_DIR, "Global_Predictors_Lev12_cluster7.csv")
GLOBAL_RESULTS_LEV12_CSV = os.path.join(OUTPUT_DIR, "Global_Results_Lev12_Full_cluster7.csv")
GLOBAL_STATS_LEV6_CSV = os.path.join(OUTPUT_DIR, "Global_Stats_Lev6_cluster7.csv")
...
def generate_maps():
    ...
    # 1. Mean
    plot_map('Mean_Log_Conc', 'Global Mean $Log_{10}(Abundance)$ (Level 6)', 'Map_Mean_Conc_cluster7.png', cmap='YlOrRd', vmin=0, vmax=7)

    # 1b. Median
    plot_map('Median_Log_Conc', 'Global Median $Log_{10}(Abundance)$ (Level 6)', 'Map_Median_Conc_cluster7.png', cmap='YlOrRd', vmin=0, vmax=7)
    
    # 2. Heterogeneity
    plot_map('Std_Log_Conc', 'Heterogeneity (Std Dev) (Level 6)', 'Map_Heterogeneity_cluster7.png', cmap='YlOrRd', vmin=0, vmax=1.5)
    
    plot_map('Anomaly', 'Abundance Anomaly', 'Map_Anomaly_cluster7.png', cmap='RdBu_r', vmin=-2.5, vmax=2.5)
