...
# CHANGED: Point to Cluster5 Model Directory
MODEL_DIR = os.path.join(PROJECT_DIR, "02_Training", "02_Model_Cluster5_Results")
# CHANGED: Unique Output Directory for Cluster5
OUTPUT_DIR = os.path.join(PROJECT_DIR, "02_Training", "03_Global_Results_Cluster5")
os.makedirs(OUTPUT_DIR, exist_ok=True)

# Input Files
# CHANGED: Correct Model Filename
MODEL_PATH = os.path.join(MODEL_DIR, "final_model_cluster5.pkl")
...
# CHANGED: Unique Filenames
GLOBAL_INDEX_CSV = os.path.join(OUTPUT_DIR, "Global_Predictors_Lev12_cluster5.csv")
GLOBAL_RESULTS_LEV12_CSV = os.path.join(OUTPUT_DIR, "Global_Results_Lev12_Full_cluster5.csv")
GLOBAL_STATS_LEV6_CSV = os.path.join(OUTPUT_DIR, "Global_Stats_Lev6_cluster5.csv")
...
def generate_maps():
    ...
    # 1. Mean
    plot_map('Mean_Log_Conc', 'Global Mean $Log_{10}(Abundance)$ (Level 6)', 'Map_Mean_Conc_cluster5.png', cmap='YlOrRd', vmin=0, vmax=7)

    # 1b. Median
    plot_map('Median_Log_Conc', 'Global Median $Log_{10}(Abundance)$ (Level 6)', 'Map_Median_Conc_cluster5.png', cmap='YlOrRd', vmin=0, vmax=7)
    
    # 2. Heterogeneity
    # User feedback: "magma not good". Changed to YlOrRd (Yellow->Red) or hot_r?
    # Trying YlOrRd for high contrast of "hotspots".
    plot_map('Std_Log_Conc', 'Heterogeneity (Std Dev) (Level 6)', 'Map_Heterogeneity_cluster5.png', cmap='YlOrRd', vmin=0, vmax=1.5)
    
    plot_map('Anomaly', 'Abundance Anomaly', 'Map_Anomaly_cluster5.png', cmap='RdBu_r', vmin=-2.5, vmax=2.5)
